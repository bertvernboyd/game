    ...
    for (var l = 0; l < layers.length; l++){
      for (var r = 0; r < rowTileCount; r++){
        for (var c = 0; c < colTileCount; c++){
          var tile = layers[ l ][ r ][ c ];
          var tileRow = Math.floor(tile / imageNumTiles);
          var tileCol = Math.floor(tile % imageNumTiles);
          this.context.drawImage(imageRepository.tileset, (tileCol * tileSize), (tileRow * tileSize), tileSize, tileSize, (c * tileSize), (r * tileSize), tileSize, tileSize);
        }
      }
    }
